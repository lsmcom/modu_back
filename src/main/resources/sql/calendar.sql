CREATE TABLE calendar_folder (
    folder_id    VARCHAR(100) PRIMARY KEY COMMENT '폴더 고유 ID',
...
CREATE TABLE plan (
    plan_id       VARCHAR(100) PRIMARY KEY COMMENT '일정 고유 ID',
    user_id       VARCHAR(100) NOT NULL COMMENT '작성자 ID (FK)',
    folder_id     VARCHAR(100) NOT NULL COMMENT '캘린더 폴더 ID (FK)',
...
CREATE TABLE plan_share (
    plan_id         VARCHAR(100) NOT NULL COMMENT '공유 일정 ID (FK)',
...
-- calendar_folder (4개 폴더)
INSERT INTO calendar_folder (folder_id, user_id, folder_name)
VALUES
    ('F001', 'user01', '폴더1'),
    ('F002', 'user01', '폴더2'),
    ('F003', 'user01', '폴더3'),
...
-- 🗓 plan (각 폴더별 2개씩, 총 8개 일정)
INSERT INTO plan (plan_id, user_id, folder_id, plan_title, plan_content, start_time, end_time, repeat_type, color, reminder)
VALUES
-- 폴더1 일정
('P001', 'user01', 'F001', '폴더1일정1', '회의 준비', '2025-11-05 09:00:00', '2025-11-05 10:00:00', '없음', '#FFB6C1', '없음'),
('P002', 'user01', 'F001', '폴더1일정2', '자료 검토', '2025-11-06 14:00:00', '2025-11-06 15:30:00', '없음', '#87CEFA', '없음'),

-- 폴더2 일정
('P003', 'user01', 'F002', '폴더2일정1', '팀 회의', '2025-11-07 10:00:00', '2025-11-07 11:00:00', '없음', '#98FB98', '없음'),
('P004', 'user01', 'F002', '폴더2일정2', '디자인 검수', '2025-11-08 13:00:00', '2025-11-08 14:00:00', '없음', '#FFD700', '없음'),

-- 폴더3 일정
('P005', 'user01', 'F003', '폴더3일정1', '기획 회의', '2025-11-09 09:00:00', '2025-11-09 10:30:00', '없음', '#DA70D6', '없음'),
('P006', 'user01', 'F003', '폴더3일정2', '문서 작성', '2025-11-10 15:00:00', '2025-11-10 17:00:00', '없음', '#FFA07A', '없음'),

-- 폴더4 일정
('P007', 'user01', 'F004', '폴더4일정1', '클라이언트 미팅', '2025-11-11 11:00:00', '2025-11-11 12:00:00', '없음', '#20B2AA', '없음'),
('P008', 'user01', 'F004', '폴더4일정2', '개발 리뷰', '2025-11-12 16:00:00', '2025-11-12 18:00:00', '없음', '#FF6347', '없음');
