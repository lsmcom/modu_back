...
""")
    ...
    List<PlanShareEntity> findBySharedUser_UserId(String userId);

    void deleteBySharedUserUserId(String sharedUserId);

    void deleteByPlanUserUserId(String planUserId);
